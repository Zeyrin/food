...
1. **On ne baisse jamais un prix, on re-explique le ROI ou on s'en va.** Baisser confirme que
   le prix initial était du pipeau.
2. **On ne développe rien avant signature.** Une démo générique réutilisable, oui. Du
   sur-mesure spéculatif, jamais.
3. **Un « non » n'est pas un verdict, c'est une ligne dans le pipeline.** La conclusion se
   tire sur 20 contacts, pas sur 1.
