  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        // La couleur du chrome navigateur est celle du haut de l'écran, pas
        // celle de la marque : un bandeau vert foncé au-dessus d'une app
        // couleur parchemin se lisait comme une barre d'un autre logiciel.
        theme_color: '#fff8ef',
